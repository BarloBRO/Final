...
urlpatterns = [
    ...
    path('login', auth_views.LoginView.as_view(template_name='employee_information/login.html',
    ...
    path('search_employees', views.search_employees, name='search-employees'),
