...
def employees(request):
    ...
    search_employees = request.GET.get('search')

    if search_employees:
        employee = Employees.objects.filter(Q(firstname__contains=search_employees))
...
def search_employees(request):
    if request.method == 'POST':
        ...
        employees = Employees.objects.filter(firstname__contains=searched)
        return render(request,
            'employee_information/search_employees.html',
                  {'searched':searched,
                   'employees':employees})
    else:
        return render(request,
...
def show(request):
    ...
    return render(request, 'employee_information/logs.html', context)